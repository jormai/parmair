...
SENSOR_DEFS = {
    ...
    "HEATING_SEASON_MOMENT": [95,10, "Asetusarvo, Lämmityskausi (hetkellinen raitis lämpötila)", "4", "8.0", "-5.0", "50.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_WRITE],
    "TE10_MIN_SUMMER_S": [96,10, "Asetusarvo, Tulolämpötilan kesä-tilassa", "4", "12.0", "10.0", "25.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_WRITE],
    "TE10_MAX_S": [97,10, "Asetusarvo, Tulolämpötilan maksimiarvo", "4", "25.0", "10.0", "35.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_WRITE],
    "BST_TE01_LIMIT": [98,10, "Asetusarvo, Tehostuksen ulkolämpötilaraja / CO2, 0-10V", "4", "-10.0", "-15.0", "0.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_WRITE],
    "M10_TYPE": [105,1, "Mittauspaikan 10 tyyppi. 0=Ei käytössä.", "10", "0", "0", "27", None, None, "mdi:information-outline", READ_WRITE],
    "M11_TYPE": [106,1, "Mittauspaikan 11 tyyppi. 0=Ei käytössä.", "10", "0", "0", "27", None, None, "mdi:information-outline", READ_WRITE],
    "M12_TYPE": [107,1, "Mittauspaikan 12 tyyppi. 0=Ei käytössä.", "10", "0", "0", "27", None, None, "mdi:information-outline", READ_WRITE],
    "SF_SPEED1_S": [108,1, "Asetusarvo, Tulopuhaltimen nopeusasetus 1", "10", "20", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "SF_SPEED2_S": [109,1, "Asetusarvo, Tulopuhaltimen nopeusasetus 2", "10", "35", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "SF_SPEED3_S": [110,1, "Asetusarvo, Tulopuhaltimen nopeusasetus 3", "10", "60", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "SF_SPEED4_S": [111,1, "Asetusarvo, Tulopuhaltimen nopeusasetus 4", "10", "75", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "SF_SPEED5_S": [112,1, "Asetusarvo, Tulopuhaltimen nopeusasetus 5", "10", "90", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "EF_SPEED1_S": [113,1, "Asetusarvo, Poistopuhaltimen nopeusasetus 1", "10", "20", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "EF_SPEED2_S": [114,1, "Asetusarvo, Poistopuhaltimen nopeusasetus 2", "10", "35", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "EF_SPEED3_S": [115,1, "Asetusarvo, Poistopuhaltimen nopeusasetus 3", "10", "60", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "EF_SPEED4_S": [116,1, "Asetusarvo, Poistopuhaltimen nopeusasetus 4", "10", "75", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    "EF_SPEED5_S": [117,1, "Asetusarvo, Poistopuhaltimen nopeusasetus 5", "10", "90", "0", "100", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_WRITE],
    ...
    "TE01_AVG_FM": [213,10, "Ulkolämpötilan vrk keskiarvo", "6", "0.0", "-50.0", "50.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_WRITE],

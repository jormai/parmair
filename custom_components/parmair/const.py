...
SENSOR_DEFS = {
"ACK_ALARMS":[3,1,"ack_alarms","1","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Odotetaan kuittausta","OK/Kuittaa"]],
...
"ME05_M":[25,1,"humid_lt_device","2","0","0","100","%",SensorDeviceClass.MOISTURE,"mdi:water-percent",READ_ONLY],
...
"TE10_CONTROL_MODE_S":[62,1,"setpoint_temp_ctrl","4","0","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["ECO","Vakio"]],
...
"TP_ENABLE_S":[70,1,"setpoint_time_prog","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Käytössä"]],
"AUTO_SUMMER_COOL_S":[71,1,"setting_summer_cool","4","2","0","2",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Käytössä","Automaatti"]],
"AUTO_SUMMER_POWER_S":[72,1,"setting_summer_perf","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Automaatti"]],
...
"AUTO_HEATER_ENABLE_S":[74,1,"setting_post_heater","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Automaatti"]],
"AUTO_COLD_LOWSPEED_S":[75,1,"setting_auto_cold_cut","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Automaatti"]],
...
"AUTO_HUMIDITY_BOOST_S":[77,1,"setting_auto_humid_boost","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Automaatti"]],
...
"AUTO_CO2_BOOST_S":[80,1,"setting_auto_co2_boost","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Automaatti"]],
"AUTO_HOMEAWAY_S":[81,1,"setting_auto_home_away_co2","4","1","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei käytössä","Automaatti"]],
...
"FILTER_INTERVAL_S":[90,1,"setpoint_filter_change","4","0","0","2",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["3kk","4kk","6kk"]],
"HP_RAD_MODE":[91,1,"setting_geo_heat_op","4","2","0","2",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Off","On","Auto"]],
...
"HEATPUMP_RADIATOR_ENABLE":[124,1,"geo_heat_coil","10","0","0","1",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Ei asennettu","Asennettu"]],
...
"DFRST_FI":[182,1,"fake_ind_lto","11","0","0","1",None,BinarySensorDeviceClass.RUNNING,"mdi:information-outline",READ_ONLY,Platform.BINARY_SENSOR],
"FG50_EA_M":[183,10,"fake_meas_lto_eff","11","0.0","0.0","100.0","%",SensorDeviceClass.POWER_FACTOR,"mdi:percent-circle",READ_ONLY],
"FILTER_STATE_FI":[184,1,"fake_setting_filter_cond","11","0","0","2",None,None,"mdi:information-outline",READ_WRITE,Platform.SELECT,["Idle","Kuittaa vaihto","Muistutushälytys"]],
...
"ME05_AVG_FM":[192,10,"fake_meas_lto_humid","11","0.0","0.0","100.0","%",SensorDeviceClass.MOISTURE,"mdi:water-percent",READ_ONLY],
...
"TE05_FA":[222,1,"error_temp_supply_lto","7","0","0","11",None,BinarySensorDeviceClass.PROBLEM,"mdi:information-outline",READ_ONLY,Platform.BINARY_SENSOR],
...
"ME05_FA":[225,1,"error_humid_lto","7","0","0","11",None,BinarySensorDeviceClass.PROBLEM,"mdi:information-outline",READ_ONLY,Platform.BINARY_SENSOR],

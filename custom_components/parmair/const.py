...
SENSOR_DEFS = {
    ...
    "TE01_M": [20,10, "Lämpötilamittaus, raitisilma", "11", "0.0", "-50.0", "120.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_ONLY],
    ...
    "TE10_M": [22,10, "Lämpötilamittaus, tuloilma", "11", "0.0", "-50.0", "120.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_ONLY],
    ...
    "TE30_M": [24,10, "Lämpötilamittaus, poistoilma", "11", "0.0", "-50.0", "120.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_ONLY],
    ...
    "QE20_M": [30,1, "Hiilidioksidimittaus, sisäilma", "11", "0", "-1", "2000", "ppm", SensorDeviceClass.CO2, "mdi:molecule-co2", READ_ONLY],
    ...
    "UNIT_CONTROL_FO": [180,1, "IV-koneen ohjaus (0=Off, 1=On)", "11", "1", "0", "1", SwitchDeviceClass.SWITCH, None, "mdi:information-outline", READ_WRITE,Platform.SWITCH],
    "USERSTATECONTROL_FO": [181,1, "MAC 2 User state control from screen. 0=Off, 1=Away, 2=Home, 3=Boost, 4=Sauna, 5=Fireplace", "11", "1", "0", "5", None, None, "mdi:information-outline", READ_WRITE,Platform.SELECT,["Off","Away","Home","Boost","Sauna","Fireplace"]],
    "DFRST_FI": [182,1, "Fiktiivinen indikointi, LTO:n sulatus päällä/pois", "11", "0", "0", "1", None, BinarySensorDeviceClass.RUNNING, "mdi:information-outline", READ_ONLY, Platform.BINARY_SENSOR],
    "FG50_EA_M": [183,10, "Fiktiivinen mittaus, LTO:n hyötysuhde", "11", "0.0", "0.0", "100.0", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_ONLY],
    "FILTER_STATE_FI": [184,1, "Fiktiivinen asetus, Suodattimen kunto (0=Idle, 1=Kuittaa vaihto, 2=Muistutushälytys)", "11", "0", "0", "2", None, None, "mdi:information-outline", READ_WRITE,Platform.SELECT,["Idle","Kuittaa vaihto","Muistutushälytys"]],
    "SENSOR_STATUS": [185,1, "Yhdistelmäanturin tila (1=Ok, 0=Initoimatta, -1=Modbuskommunikaatiovirhe, -2=Data puuttuu)", "1", "0", "-2", "1", None, None, "mdi:information-outline", READ_ONLY],
    "FAN_SPEED_I": [187,1, "Tilatieto, IV nopeusasetus", "11", "0", "1", "4", None, None, "mdi:information-outline", READ_ONLY],
    "SUMMER_MODE_I": [189,1, "Tilatieto, Kausi. 0=Talvi, 1=Väli, 2=Kesä", "1", "0", "0", "2", None, None, "mdi:information-outline", READ_ONLY],
    "SUMMER_POWER_CHANGE_FM": [190,1, "Kesätilanteen tehonsäätö", "1", "0", "-1", "1", None, None, "mdi:information-outline", READ_ONLY],
    "HUMIDITY_FM": [191,100, "Laskettu kosteus", "1", "0.00", "0.00", "100.00", "g/kg", SensorDeviceClass.MOISTURE, "mdi:water-percent", READ_ONLY],
    "ME05_AVG_FM": [192,10, "Fiktiivinen mittaus, LTO:n kosteusmittauksen 24h keskiarvo", "11", "0.0", "0.0", "100.0", "%", SensorDeviceClass.MOISTURE, "mdi:water-percent", READ_ONLY],
    "PWR_LIMIT_FY": [199,10, "Fiktiivinen säätö, puhaltimien tehonrajoitus", "1", "0.0", "0.0", "100.0", "%", SensorDeviceClass.POWER_FACTOR, "mdi:percent-circle", READ_ONLY],
    "TE01_AVG_FM": [213,10, "Ulkolämpötilan vrk keskiarvo", "1", "0.0", "-50.0", "50.0", "°C", SensorDeviceClass.TEMPERATURE, "mdi:temperature-celsius", READ_ONLY],
